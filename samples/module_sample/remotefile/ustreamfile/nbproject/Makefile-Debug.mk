...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libustreamfile.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libustreamfile.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -std=c++11 -static-libgcc -static-libstdc++ -shared -fPIC
...
${OBJECTDIR}/_ext/1429980336/sfileimpl.o: ../../../../include/file/server_impl/sfileimpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1429980336/sfileimpl.o ../../../../include/file/server_impl/sfileimpl.cpp

${OBJECTDIR}/_ext/1429980336/ustreamfile.o: ../../../../include/file/server_impl/ustreamfile.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1429980336
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1429980336/ustreamfile.o ../../../../include/file/server_impl/ustreamfile.cpp
