...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libuasyncqueue.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libuasyncqueue.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -std=c++11 -static-libgcc -static-libstdc++ -shared -fPIC
...
${OBJECTDIR}/_ext/1728828599/asyncqueueimpl.o: ../../../../include/queue/server_impl/asyncqueueimpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1728828599/asyncqueueimpl.o ../../../../include/queue/server_impl/asyncqueueimpl.cpp

${OBJECTDIR}/_ext/1728828599/uasyncqueue.o: ../../../../include/queue/server_impl/uasyncqueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1728828599
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1728828599/uasyncqueue.o ../../../../include/queue/server_impl/uasyncqueue.cpp
