...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cplusplus: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cplusplus ${OBJECTFILES} ${LDLIBSOPTIONS} -std=c++11 -lstdc++
...
${OBJECTDIR}/_ext/877975035/tablecache.o: ../../shared/tablecache.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/877975035/tablecache.o ../../shared/tablecache.cpp

${OBJECTDIR}/config.o: config.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config.o config.cpp
