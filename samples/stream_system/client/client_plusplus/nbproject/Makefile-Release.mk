...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/client_plusplus: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/client_plusplus ${OBJECTFILES} ${LDLIBSOPTIONS} -std=c++11 -lstdc++ -s
...
${OBJECTDIR}/_ext/562988696/error_code.o: ../../../../include/error_code.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/562988696
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/562988696/error_code.o ../../../../include/error_code.cpp
...
${OBJECTDIR}/client_plusplus.o: client_plusplus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/client_plusplus.o client_plusplus.cpp

${OBJECTDIR}/stdafx.o: stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stdafx.o stdafx.cpp

${OBJECTDIR}/webasynchandler.o: webasynchandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/webasynchandler.o webasynchandler.cpp
