...
// UFile.cpp : Implementation of DLL Exports.
...
//
//      Modify the custom build rule for UFile.idl by adding the following 
//      files to the Outputs.
//          UFile_p.c
//          dlldata.c
//      To build a separate proxy/stub DLL, 
//      run nmake -f UFileps.mk in the project directory.
...
OBJECT_ENTRY(CLSID_UFile, CUFile)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_UFILELib);
