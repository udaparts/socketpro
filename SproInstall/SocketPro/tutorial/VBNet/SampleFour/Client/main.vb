...
Namespace RAdo
	...
	Public Class frmRemotingAdoNet
		Inherits Form
		Private Const Failover As Integer = 11111
		Private Const ExceedingMaxJobQueueSize As Integer = 11112
		Private Const JobQueueNormal As Integer = 11113
		Private Const NoRealServerAvailable As Integer = 11114
		...
		Private Sub InitializeComponent()
            ...
            Me.btnGetDR.Location = New System.Drawing.Point(16, 79)
            ...
            Me.btnGetDS.Location = New System.Drawing.Point(128, 79)
            ...
            Me.btnSendDR.Location = New System.Drawing.Point(232, 79)
            ...
            Me.btnSendDS.Location = New System.Drawing.Point(352, 79)
            ...
            Me.label3.Text = "Loading Balancer Status:"
            '
            'txtLBStatus
            '
            Me.txtLBStatus.Location = New System.Drawing.Point(146, 57)
            Me.txtLBStatus.Name = "txtLBStatus"
            Me.txtLBStatus.ReadOnly = True
            Me.txtLBStatus.Size = New System.Drawing.Size(292, 20)
            Me.txtLBStatus.TabIndex = 14
            Me.txtLBStatus.Text = "Normal"
            '
            'dgTable
            '
            Me.dgTable.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize
            Me.dgTable.Location = New System.Drawing.Point(13, 109)
            Me.dgTable.Name = "dgTable"
            Me.dgTable.Size = New System.Drawing.Size(425, 263)
            Me.dgTable.TabIndex = 15
            '
            'frmRemotingAdoNet
            '
  ...
  Shared Sub Main()
		...
		Private Sub OnBaseRequestCome(ByVal sRequestId As Short)
			Select Case sRequestId
				Case CShort(Fix(USOCKETLib.tagChatRequestID.idSendUserMessage)), CShort(Fix(USOCKETLib.tagChatRequestID.idSpeak)), CShort(Fix(USOCKETLib.tagChatRequestID.idXSpeak))
						Dim obj As Object = m_ClientSocket.GetUSocket().Message
						Select Case CInt(Fix(obj))
							Case Failover
		...
		Private Sub frmRemotingAdoNet_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            m_ClientSocket.m_OnBaseRequestProcessed = AddressOf OnBaseRequestCome
		End Sub
