...
namespace NJA {
    ...
    void NJClientQueue::Init(Local<Object> exports) {
        ...
        tpl->SetClassName(ToStr(isolate, u"CClientQueue", 12));
        ...
        exports->Set(ctx, ToStr(isolate, u"CClientQueue", 12), tpl->GetFunction(ctx).ToLocalChecked());
    }
    ...
    void NJClientQueue::StartQueue(const FunctionCallbackInfo<Value>& args) {
        ...
        bool secure = (ClientCoreLoader.GetEncryptionMethod(obj->m_cq->GetHandle()) != tagEncryptionMethod::NoEncryption);
        p = args[1];
