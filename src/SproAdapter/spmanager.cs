                ...
                case ClientSide.CMysql.sidMysql:
                    switch (pc.PoolType)
                    {
                        ...
                        case ClientSide.tagPoolType.Master:
                            pool = new CSqlMasterPool<ClientSide.CMysql, CDataSet>(pc.DefaultDb, m_bMiddle, pc.RecvTimeout, pc.AutoConn, pc.ConnTimeout);
                            break;
                        default:
                ...
                case BaseServiceID.sidODBC:
                    switch (pc.PoolType)
                    {
                        case ClientSide.tagPoolType.Slave:
                            ...
                            break;
                        case ClientSide.tagPoolType.Master:
                            pool = new CSqlMasterPool<ClientSide.COdbc, CDataSet>(pc.DefaultDb, m_bMiddle, pc.RecvTimeout, pc.AutoConn, pc.ConnTimeout);
                            break;
                        default:
                ...
                case ClientSide.CSqlite.sidSqlite:
                    switch (pc.PoolType)
                    {
                        case ClientSide.tagPoolType.Slave:
                            ...
                            break;
                        case ClientSide.tagPoolType.Master:
                            pool = new CSqlMasterPool<ClientSide.CSqlite, CDataSet>(pc.DefaultDb, m_bMiddle, pc.RecvTimeout, pc.AutoConn, pc.ConnTimeout);
                            break;
                        default:
