...
${OBJECTDIR}/_ext/932346631/membuffer.o: ../../../include/membuffer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/lib/jvm/java-7-openjdk-amd64/include -I/usr/lib/jvm/java-7-openjdk-amd64/include/linux -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/932346631/membuffer.o ../../../include/membuffer.cpp
