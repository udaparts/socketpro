...
namespace PA
{
    ...
    void CPhpTable::RegisterInto(Php::Namespace & spa) {
        ...
        table.property("great", SPA::CTable::great, Php::Const);
        table.property("less", SPA::CTable::less, Php::Const);
        table.property("great_equal", SPA::CTable::great_equal, Php::Const);
        table.property("less_equal", SPA::CTable::less_equal, Php::Const);
