...
var cc2Mysql = gcs.CConnectionContext{Host: "windesk", UserId: "root", Password: "Smash123", Port: 20901}
...
func Test_mysql_db_simple_calls_in_streaming(t *testing.T) {
	...
	ok := sp.StartSocketPool(cc2Mysql, 1)
...
func Test_mysql_db_execute_sql(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_execute_SQLs_in_streaming(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_receiving_blobs(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_with_simple_session_variables(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_with_simple_parepared_statement(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_by_prepared_statements(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_with_session_variables(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_store_procedure_by_session_variables(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_store_procedure_by_prepared_parameters(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
...
func Test_mysql_db_batch(t *testing.T) {
	sp := gcs.NewPool(gdb.SidMysql)
	sp.SetPoolEvent(func(spe gcs.SocketPoolEvent, h *gcs.CAsyncHandler) {
		if spe == gcs.SpeSocketCreated {
			db := new(gdb.CDBHandler)
