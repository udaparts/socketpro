...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/all_servers: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/all_servers ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread

${OBJECTDIR}/_ext/932346631/aserverw.o: ../../../include/aserverw.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/932346631
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/932346631/aserverw.o ../../../include/aserverw.cpp
...
${OBJECTDIR}/_ext/1510806711/mstruct.o: ../uqueue_demo/mstruct.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1510806711/mstruct.o ../uqueue_demo/mstruct.cpp

${OBJECTDIR}/all_servers.o: all_servers.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/all_servers.o all_servers.cpp
