    ...
    protected boolean OnIsPermitted(long hSocket, String userId, String password, int nSvsID) {
        ...
        switch (nSvsID) {
            ...
            case SPA.ClientSide.CPostgres.sidPostgres:
                res = Plugin.DoSPluginAuthentication("spostgres", hSocket, userId, password, nSvsID, "Server=localhost;timeout=45;max_SQLs_batched=16");
                break;
            case SPA.ClientSide.CSqlServer.sidMsSql:
                res = Plugin.DoSPluginAuthentication("usqlsvr", hSocket, userId, password, nSvsID, "Server=localhost;timeout=45;max_SQLs_batched=16");
                break;
            ...
            case SPA.ClientSide.CMysql.sidMysql:
                res = Plugin.DoSPluginAuthentication("smysql", hSocket, userId, password, nSvsID, "server=localhost;max_sqls_batched=16");
                break;
