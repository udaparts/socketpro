    ...
    switch (vt) {
        case VT_I1:
            switch (pvarSrc->vt) {
                ...
                {
                    SPA::INT64 data;
                    int res = swscanf(pvarSrc->bstrVal, L"%ld", &data);
                    if (res)
        ...
        case VT_UI1:
            switch (pvarSrc->vt) {
                ...
                {
                    SPA::UINT64 data;
                    int res = swscanf(pvarSrc->bstrVal, L"%lu", &data);
                    if (res)
        ...
        case VT_UI8:
            switch (pvarSrc->vt) {
                ...
                case VT_R8:
                    ...
                    break;
                case VT_BOOL:
                    pvargDest->ullVal = (SPA::UINT64) (pvarSrc->boolVal ? 1 : 0);
                    break;
                case VT_DECIMAL:
