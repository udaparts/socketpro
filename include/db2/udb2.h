#ifndef _SOCKETPRO_DB2_PLUGIN_H_
#define _SOCKETPRO_DB2_PLUGIN_H_
...
namespace SPA {
    namespace Db2 {
        static const unsigned int sidDB2 = (unsigned int) tagServiceID::sidReserved + 0x6FFFFFF3; //asynchronous DB2 service id

        //DB2 meta recordsets and error codes are the same ones as ODBC
        /*
        //meta recordsets
        ...
        //error codes from async DB2 server plugin library
