...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libspmysqlpush.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libspmysqlpush.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -s -fPIC
...
${OBJECTDIR}/_ext/1332925342/dbupdateimpl.o: ../udbubase/dbupdateimpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -DNDEBUG -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1332925342/dbupdateimpl.o ../udbubase/dbupdateimpl.cpp

${OBJECTDIR}/_ext/1332925342/udbubase.o: ../udbubase/udbubase.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1332925342
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -DNDEBUG -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1332925342/udbubase.o ../udbubase/udbubase.cpp

${OBJECTDIR}/spmysqlpush.o: spmysqlpush.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -DNDEBUG -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/spmysqlpush.o spmysqlpush.cpp
