DELIMITER @@
CREATE FUNCTION SetConnectionString RETURNS INTEGER SONAME 'spmysqlpush.dll'; /* libspmysqlpush.so on linux platforms */
@@
CREATE FUNCTION NotifyDatabaseEvent RETURNS STRING SONAME 'spmysqlpush.dll';
@@
CREATE FUNCTION GetConnections RETURNS STRING SONAME 'spmysqlpush.dll';
@@
/*
demo statements
*/
