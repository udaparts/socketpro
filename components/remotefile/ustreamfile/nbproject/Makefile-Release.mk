...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libustreamfile.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libustreamfile.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -std=c++11 -static-libstdc++ -shared -s -fPIC
...
${OBJECTDIR}/_ext/329294815/ustreamfile.o: ../../../include/file/server_impl/ustreamfile.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/329294815
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -DNDEBUG -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/329294815/ustreamfile.o ../../../include/file/server_impl/ustreamfile.cpp
