...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_squeue: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/test_squeue ${OBJECTFILES} ${LDLIBSOPTIONS} -std=c++11 -pthread
...
${OBJECTDIR}/test_squeue.o: test_squeue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_squeue.o test_squeue.cpp
