...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libuasyncqueue.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libuasyncqueue.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -lstdc++ -Wl,--no-undefined -shared -fPIC
...
${OBJECTDIR}/_ext/431783432/asyncqueueimpl.o: ../../../include/queue/server_impl/asyncqueueimpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/431783432/asyncqueueimpl.o ../../../include/queue/server_impl/asyncqueueimpl.cpp

${OBJECTDIR}/_ext/431783432/qexports.o: ../../../include/queue/server_impl/qexports.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/431783432
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/431783432/qexports.o ../../../include/queue/server_impl/qexports.cpp

${OBJECTDIR}/_ext/431783432/uasyncqueue.o: ../../../include/queue/server_impl/uasyncqueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/431783432
	${RM} "$@.d"
	$(COMPILE.c) -g -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/431783432/uasyncqueue.o ../../../include/queue/server_impl/uasyncqueue.cpp
