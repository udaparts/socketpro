...
class Program
{
    static void Main(string[] args)
    {
        ...
        using (CSocketPool<CStreamingFile> spRf = new CSocketPool<CStreamingFile>())
        {
            ...
            RemoteFile = "libboost_wave-vc100-mt-sgd-x64-1_68.lib";
            ok = rf.Download(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
            ...
            RemoteFile = "libboost_coroutine-vc100-mt-s-x64-1_68.lib";
            ok = rf.Download(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
            ...
            RemoteFile = "libboost_serialization-vc100-mt-s-x64-1_68.lib";
            ok = rf.Download(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
            ...
            RemoteFile = "libboost_math_tr1f-vc100-mt-sgd-x64-1_68.lib";
            ok = rf.Download(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
            ...
            LocalFile = "spfile2.test";
            RemoteFile = "libboost_wave-vc100-mt-sgd-x64-1_68_copy.lib";
            ok = rf.Upload(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
            ...
            LocalFile = "spfile3.test";
            RemoteFile = "libboost_coroutine-vc100-mt-s-x64-1_68_copy.lib";
            ok = rf.Upload(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
            ...
            LocalFile = "spfile4.test";
            RemoteFile = "libboost_serialization-vc100-mt-s-x64-1_68_copy.lib";
            ok = rf.Upload(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
            ...
            LocalFile = "spfile5.test";
            RemoteFile = "libboost_math_tr1f-vc100-mt-sgd-x64-1_68_copy.lib";
            ok = rf.Upload(LocalFile, RemoteFile, (file, res, errMsg) =>
            {
                if (res != 0)
                    Console.WriteLine("Error code: {0}, error message: {1}", res, errMsg);
