...
${OBJECTDIR}/_ext/1559065848/aclientw.o: ../../include/aclientw.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1559065848/aclientw.o ../../include/aclientw.cpp

${OBJECTDIR}/_ext/1559065848/membuffer.o: ../../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1559065848
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -DNDEBUG -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1559065848/membuffer.o ../../include/membuffer.cpp
