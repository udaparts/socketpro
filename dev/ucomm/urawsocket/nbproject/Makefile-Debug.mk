...
${OBJECTDIR}/_ext/1761269253/once.o: ../../../../Downloads/boost/libs/thread/src/pthread/once.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1761269253/once.o ../../../../Downloads/boost/libs/thread/src/pthread/once.cpp

${OBJECTDIR}/_ext/1761269253/thread.o: ../../../../Downloads/boost/libs/thread/src/pthread/thread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1761269253
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1761269253/thread.o ../../../../Downloads/boost/libs/thread/src/pthread/thread.cpp

${OBJECTDIR}/_ext/53904016/tss_null.o: ../../../../Downloads/boost/libs/thread/src/tss_null.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/53904016
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/53904016/tss_null.o ../../../../Downloads/boost/libs/thread/src/tss_null.cpp

${OBJECTDIR}/_ext/1719658846/includes.o: ../core_shared/shared/includes.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1719658846
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1719658846/includes.o ../core_shared/shared/includes.cpp

${OBJECTDIR}/_ext/1719658846/myopenssl.o: ../core_shared/shared/myopenssl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1719658846
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1719658846/myopenssl.o ../core_shared/shared/myopenssl.cpp

${OBJECTDIR}/_ext/1719658846/ucertimpl.o: ../core_shared/shared/ucertimpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1719658846
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1719658846/ucertimpl.o ../core_shared/shared/ucertimpl.cpp

${OBJECTDIR}/_ext/1719658846/uthread.o: ../core_shared/shared/uthread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1719658846
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1719658846/uthread.o ../core_shared/shared/uthread.cpp

${OBJECTDIR}/_ext/262068057/membuffer.o: ../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/262068057
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/262068057/membuffer.o ../include/membuffer.cpp

${OBJECTDIR}/_ext/760551045/getsysid.o: ../uzip/getsysid.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/760551045
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/760551045/getsysid.o ../uzip/getsysid.cpp

${OBJECTDIR}/_ext/760551045/mqfile.o: ../uzip/mqfile.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/760551045
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/760551045/mqfile.o ../uzip/mqfile.cpp

${OBJECTDIR}/_ext/760551045/sha1.o: ../uzip/sha1.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/760551045
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/760551045/sha1.o ../uzip/sha1.cpp

${OBJECTDIR}/pch.o: pch.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pch.o pch.cpp

${OBJECTDIR}/rawsession.o: rawsession.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rawsession.o rawsession.cpp

${OBJECTDIR}/rawthread.o: rawthread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rawthread.o rawthread.cpp

${OBJECTDIR}/urawsocket.o: urawsocket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -DU_RAW_SOCKET -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/urawsocket.o urawsocket.cpp
