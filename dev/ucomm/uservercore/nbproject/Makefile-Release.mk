...
${OBJECTDIR}/_ext/648362257/fastujson.o: ../servercore/fastujson.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/648362257
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -DNDEBUG -DUSE_SPIRIT_CLSSICAL_FOR_MULTIPART `pkg-config --cflags libcrypto` `pkg-config --cflags libssl`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/648362257/fastujson.o ../servercore/fastujson.cpp
