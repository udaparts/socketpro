...
extern "C" {
    ...
    void U_MODULE_OPENED WINAPI SetOdbcDBGlobalConnectionString(const wchar_t *dbConnection);
    bool U_MODULE_OPENED WINAPI DoODBCAuthentication(USocket_Server_Handle hSocket, const wchar_t *userId, const wchar_t *password, unsigned int nSvsId, const wchar_t *odbcDriver, const wchar_t *dsn);
