...
public:
	...
	void Encrypt(unsigned char* buf, size_t n, int iMode=CBC);
	void Decrypt(unsigned char* buf, size_t n, int iMode=CBC);

	// Encrypt/Decrypt from Input Buffer to Output Buffer
	void Encrypt(const unsigned char* in, unsigned char* out, size_t n, int iMode=CBC);
	void Decrypt(const unsigned char* in, unsigned char* out, size_t n, int iMode=CBC);
