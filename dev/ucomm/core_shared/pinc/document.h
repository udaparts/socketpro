...
#pragma pack (push, 4)
    ...
    public:
        ...
        GenericValue(double d) : flags_(kNumberDoubleFlag) {
            data_.n.d = d;
        }
        ...
        GenericValue(const Ch* s) {
            SetStringRaw(s, internal::StrLen(s));
        }
        ...
        /*! \param rhs Source of the assignment. It will become a null value after move assignment.
         */
#ifndef WINCE
        ...
        /*! \param rhs Source of the assignment. It will become a null value after move constructor.
         */
        ...
        GenericValue& operator[](const Ch* name) {
            if (Member * member = FindMember(name))
                ...
                static GenericValue NullValue(kNullFlag);
                return NullValue;
            }
        }
    ...
    \endcode
        ...
        GenericValue& SetString(const Ch* s) {
            return SetString(s, internal::StrLen(s));
        }
        ...
        GenericValue& Accept(Handler& handler) {
            switch (GetType()) {
                case kNullType: handler.Null();
                    break;
                case kFalseType: handler.Bool(false);
                    break;
                case kTrueType: handler.Bool(true);
                    break;
