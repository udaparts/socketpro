...
LDLIBSOPTIONS=-L../../ServerCore/uservercore/dist/Debug/GNU-Linux-x86 -ldl -lpthread
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/userver: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/userver ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/1441729126/error_code.o: ../../../../../Downloads/boost/libs/system/src/error_code.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1441729126
	$(COMPILE.cc) -g -o ${OBJECTDIR}/_ext/1441729126/error_code.o ../../../../../Downloads/boost/libs/system/src/error_code.cpp

${OBJECTDIR}/_ext/932346631/aserverw.o: ../../../include/aserverw.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/932346631
	$(COMPILE.cc) -g -o ${OBJECTDIR}/_ext/932346631/aserverw.o ../../../include/aserverw.cpp

${OBJECTDIR}/_ext/932346631/membuffer.o: ../../../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/932346631
	$(COMPILE.cc) -g -o ${OBJECTDIR}/_ext/932346631/membuffer.o ../../../include/membuffer.cpp

${OBJECTDIR}/_ext/1472/sproserver.o: ../sproserver.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	$(COMPILE.cc) -g -o ${OBJECTDIR}/_ext/1472/sproserver.o ../sproserver.cpp

${OBJECTDIR}/_ext/1472/stdafx.o: ../stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	$(COMPILE.cc) -g -o ${OBJECTDIR}/_ext/1472/stdafx.o ../stdafx.cpp
