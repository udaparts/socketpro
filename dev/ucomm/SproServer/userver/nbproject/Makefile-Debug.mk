...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/userver: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/userver ${OBJECTFILES} ${LDLIBSOPTIONS} -lstdc++ -pthread

${OBJECTDIR}/_ext/1559065848/aserverw.o: ../../include/aserverw.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1559065848
	$(COMPILE.c) -g -o ${OBJECTDIR}/_ext/1559065848/aserverw.o ../../include/aserverw.cpp

${OBJECTDIR}/_ext/1559065848/membuffer.o: ../../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1559065848
	$(COMPILE.c) -g -o ${OBJECTDIR}/_ext/1559065848/membuffer.o ../../include/membuffer.cpp
