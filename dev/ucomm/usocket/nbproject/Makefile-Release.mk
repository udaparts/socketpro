...
LDLIBSOPTIONS=../uzip/dist/Release/GNU-Linux-x86/libuzip.a -ldl `pkg-config --libs libcrypto` -lpthread  `pkg-config --libs libssl` -lm  /usr/lib/gcc/x86_64-linux-gnu/4.8.4/libstdc++.a  
