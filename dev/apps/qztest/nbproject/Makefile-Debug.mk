...
LDLIBSOPTIONS=-lboost_system ../uzip/uzip/dist/Debug/GNU-Linux-x86/libuzip.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/qztest

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/qztest: ../uzip/uzip/dist/Debug/GNU-Linux-x86/libuzip.a
...
${OBJECTDIR}/qztest.o: qztest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/qztest.o qztest.cpp
