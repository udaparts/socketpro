...
LDLIBSOPTIONS=-lssl -lpthread -lboost_system
...
${OBJECTDIR}/jsloader.o: jsloader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/jsloader.o jsloader.cpp

${OBJECTDIR}/asyncsession.o: asyncsession.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/asyncsession.o asyncsession.cpp

${OBJECTDIR}/appsettings.o: appsettings.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/appsettings.o appsettings.cpp
...
${OBJECTDIR}/techunkedgrammar.o: techunkedgrammar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/techunkedgrammar.o techunkedgrammar.cpp

${OBJECTDIR}/hparser.o: hparser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/hparser.o hparser.cpp

${OBJECTDIR}/httpgrammar.o: httpgrammar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/httpgrammar.o httpgrammar.cpp

${OBJECTDIR}/_ext/1559065848/membuffer.o: ../../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1559065848
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1559065848/membuffer.o ../../include/membuffer.cpp
...
${OBJECTDIR}/asyncserver.o: asyncserver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/asyncserver.o asyncserver.cpp

${OBJECTDIR}/multipartgrammar.o: multipartgrammar.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/multipartgrammar.o multipartgrammar.cpp

${OBJECTDIR}/httpcontext.o: httpcontext.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/httpcontext.o httpcontext.cpp
