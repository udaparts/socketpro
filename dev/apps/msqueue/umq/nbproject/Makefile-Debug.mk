...
LDLIBSOPTIONS=../../uzip/uzip/dist/Debug/GNU-Linux-x86/libuzip.a -lpthread -lrt

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/umq

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/umq: ../../uzip/uzip/dist/Debug/GNU-Linux-x86/libuzip.a
...
${OBJECTDIR}/_ext/1441729126/error_code.o: ../../../../../Downloads/boost/libs/system/src/error_code.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1441729126/error_code.o ../../../../../Downloads/boost/libs/system/src/error_code.cpp

${OBJECTDIR}/_ext/386121535/future.o: ../../../../../Downloads/boost/libs/thread/src/future.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/386121535
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/386121535/future.o ../../../../../Downloads/boost/libs/thread/src/future.cpp

${OBJECTDIR}/_ext/323364652/once.o: ../../../../../Downloads/boost/libs/thread/src/pthread/once.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/323364652
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/323364652/once.o ../../../../../Downloads/boost/libs/thread/src/pthread/once.cpp

${OBJECTDIR}/_ext/323364652/thread.o: ../../../../../Downloads/boost/libs/thread/src/pthread/thread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/323364652
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/323364652/thread.o ../../../../../Downloads/boost/libs/thread/src/pthread/thread.cpp

${OBJECTDIR}/_ext/386121535/tss_null.o: ../../../../../Downloads/boost/libs/thread/src/tss_null.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/386121535
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/386121535/tss_null.o ../../../../../Downloads/boost/libs/thread/src/tss_null.cpp

${OBJECTDIR}/_ext/932346631/membuffer.o: ../../../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/932346631
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/932346631/membuffer.o ../../../include/membuffer.cpp

${OBJECTDIR}/_ext/1472/msqueue.o: ../msqueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/msqueue.o ../msqueue.cpp

${OBJECTDIR}/_ext/1472/stdafx.o: ../stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -g -std=c++11 -static-libgcc -static-libstdc++ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/stdafx.o ../stdafx.cpp
