...
//--------------------------------------------------------------------------------------//
                ...
                const codecvt_type & cvt)
  {
    ...
    std::size_t buf_size = (from_end - from) * sizeof(wchar_t);  // perhaps too large, but that's OK
    buf_size += sizeof(wchar_t);  // encodings like shift-JIS need some prefix space
