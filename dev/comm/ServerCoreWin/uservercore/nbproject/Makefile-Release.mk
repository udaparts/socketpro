...
${OBJECTDIR}/_ext/1472/listimpl.o: ../listimpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -DNDEBUG -DUSE_SPIRIT_CLSSICAL_FOR_MULTIPART `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/listimpl.o ../listimpl.cpp
...
${OBJECTDIR}/_ext/1472/serverthread.o: ../serverthread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -DNDEBUG -DUSE_SPIRIT_CLSSICAL_FOR_MULTIPART `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/serverthread.o ../serverthread.cpp

${OBJECTDIR}/_ext/1472/servicecontext.o: ../servicecontext.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -DNDEBUG -DUSE_SPIRIT_CLSSICAL_FOR_MULTIPART `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/servicecontext.o ../servicecontext.cpp
...
${OBJECTDIR}/_ext/1472/svrimpl.o: ../svrimpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -DNDEBUG -DUSE_SPIRIT_CLSSICAL_FOR_MULTIPART `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/svrimpl.o ../svrimpl.cpp
