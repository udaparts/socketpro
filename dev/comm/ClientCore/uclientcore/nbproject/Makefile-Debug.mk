...
${OBJECTDIR}/_ext/672919334/chrono.o: ../../../../../Downloads/boost/libs/chrono/src/chrono.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/672919334/chrono.o ../../../../../Downloads/boost/libs/chrono/src/chrono.cpp

${OBJECTDIR}/_ext/932346631/membuffer.o: ../../../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/932346631
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/932346631/membuffer.o ../../../include/membuffer.cpp

${OBJECTDIR}/_ext/877975035/includes.o: ../../shared/includes.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/877975035
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/877975035/includes.o ../../shared/includes.cpp

${OBJECTDIR}/_ext/877975035/ucertimpl.o: ../../shared/ucertimpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/877975035
	${RM} "$@.d"
	$(COMPILE.c) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/877975035/ucertimpl.o ../../shared/ucertimpl.cpp

${OBJECTDIR}/_ext/877975035/uthread.o: ../../shared/uthread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/877975035
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/877975035/uthread.o ../../shared/uthread.cpp

${OBJECTDIR}/_ext/1472/clientcore.o: ../clientcore.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/clientcore.o ../clientcore.cpp

${OBJECTDIR}/_ext/1472/clientglobal.o: ../clientglobal.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/clientglobal.o ../clientglobal.cpp

${OBJECTDIR}/_ext/1472/clientsession.o: ../clientsession.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/clientsession.o ../clientsession.cpp

${OBJECTDIR}/_ext/1472/clientthread.o: ../clientthread.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/clientthread.o ../clientthread.cpp

${OBJECTDIR}/_ext/1472/csocketimpl.o: ../csocketimpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/csocketimpl.o ../csocketimpl.cpp

${OBJECTDIR}/_ext/1472/socketpool.o: ../socketpool.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/socketpool.o ../socketpool.cpp

${OBJECTDIR}/_ext/1472/stdafx.o: ../stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} "$@.d"
	$(COMPILE.cc) -g -DOLD_IMPL `pkg-config --cflags libcrypto`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1472/stdafx.o ../stdafx.cpp
