...
${OBJECTDIR}/_ext/1165644825/mmexports.o: ../../../include/mysql/server_impl/mmexports.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DUSE_BOOST_LARGE_INTEGER_FOR_DECIMAL -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1165644825/mmexports.o ../../../include/mysql/server_impl/mmexports.cpp

${OBJECTDIR}/_ext/1165644825/mysqlimpl.o: ../../../include/mysql/server_impl/mysqlimpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1165644825
	${RM} "$@.d"
	$(COMPILE.c) -g -DUSE_BOOST_LARGE_INTEGER_FOR_DECIMAL -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1165644825/mysqlimpl.o ../../../include/mysql/server_impl/mysqlimpl.cpp

${OBJECTDIR}/_ext/1165644825/smysql.o: ../../../include/mysql/server_impl/smysql.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1165644825
	${RM} "$@.d"
	$(COMPILE.c) -g -DUSE_BOOST_LARGE_INTEGER_FOR_DECIMAL -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1165644825/smysql.o ../../../include/mysql/server_impl/smysql.cpp
