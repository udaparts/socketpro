...
${OBJECTDIR}/_ext/1832277304/mysqlimpl.o: ../../../../include/mysql/server_impl/mysqlimpl.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -DNDEBUG -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1832277304/mysqlimpl.o ../../../../include/mysql/server_impl/mysqlimpl.cpp

${OBJECTDIR}/_ext/1832277304/smysql.o: ../../../../include/mysql/server_impl/smysql.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1832277304
	${RM} "$@.d"
	$(COMPILE.c) -O2 -s -DNDEBUG -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1832277304/smysql.o ../../../../include/mysql/server_impl/smysql.cpp
