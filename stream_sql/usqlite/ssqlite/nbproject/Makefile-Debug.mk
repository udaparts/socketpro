...
${OBJECTDIR}/_ext/1689552657/sexports.o: ../../../include/sqlite/server_impl/sexports.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DHAVE_GMTIME_R -DHAVE_LOCALTIME_S -DSQLITE_DEFAULT_FOREIGN_KEYS=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_FTS4 -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_RTREE -DSQLITE_OMIT_LOOKASIDE -DSQLITE_THREADSAFE=1 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1689552657/sexports.o ../../../include/sqlite/server_impl/sexports.cpp
