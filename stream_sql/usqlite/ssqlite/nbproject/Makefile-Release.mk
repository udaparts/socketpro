...
${OBJECTDIR}/_ext/932346631/aserverw.o: ../../../include/aserverw.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -DHAVE_GMTIME_R -DHAVE_LOCALTIME_S -DNDEBUG -DSQLITE_DEFAULT_FOREIGN_KEYS=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_FTS4 -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_RTREE -DSQLITE_OMIT_LOOKASIDE -DSQLITE_THREADSAFE=1 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/932346631/aserverw.o ../../../include/aserverw.cpp
...
${OBJECTDIR}/_ext/1689552657/sqlite3.o: ../../../include/sqlite/server_impl/sqlite3.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1689552657
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -DHAVE_GMTIME_R -DHAVE_LOCALTIME_S -DNDEBUG -DSQLITE_DEFAULT_FOREIGN_KEYS=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_FTS4 -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_RTREE -DSQLITE_OMIT_LOOKASIDE -DSQLITE_THREADSAFE=1 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1689552657/sqlite3.o ../../../include/sqlite/server_impl/sqlite3.c

${OBJECTDIR}/_ext/1689552657/sqliteimpl.o: ../../../include/sqlite/server_impl/sqliteimpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1689552657
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -DHAVE_GMTIME_R -DHAVE_LOCALTIME_S -DNDEBUG -DSQLITE_DEFAULT_FOREIGN_KEYS=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_FTS4 -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_RTREE -DSQLITE_OMIT_LOOKASIDE -DSQLITE_THREADSAFE=1 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1689552657/sqliteimpl.o ../../../include/sqlite/server_impl/sqliteimpl.cpp

${OBJECTDIR}/_ext/1689552657/ssqlite.o: ../../../include/sqlite/server_impl/ssqlite.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1689552657
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s -DHAVE_GMTIME_R -DHAVE_LOCALTIME_S -DNDEBUG -DSQLITE_DEFAULT_FOREIGN_KEYS=1 -DSQLITE_ENABLE_COLUMN_METADATA -DSQLITE_ENABLE_FTS4 -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_RTREE -DSQLITE_OMIT_LOOKASIDE -DSQLITE_THREADSAFE=1 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1689552657/ssqlite.o ../../../include/sqlite/server_impl/ssqlite.cpp
