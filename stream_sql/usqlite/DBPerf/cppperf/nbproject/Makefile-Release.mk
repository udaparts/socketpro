...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppperf: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppperf ${OBJECTFILES} ${LDLIBSOPTIONS} -lstdc++ -s

${OBJECTDIR}/_ext/726959463/aclientw.o: ../../../../../include/aclientw.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/726959463
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/726959463/aclientw.o ../../../../../include/aclientw.cpp

${OBJECTDIR}/_ext/726959463/error_code.o: ../../../../../include/error_code.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/726959463
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/726959463/error_code.o ../../../../../include/error_code.cpp

${OBJECTDIR}/_ext/726959463/membuffer.o: ../../../../../include/membuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/726959463
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/726959463/membuffer.o ../../../../../include/membuffer.cpp

${OBJECTDIR}/cppperf.o: cppperf.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cppperf.o cppperf.cpp
